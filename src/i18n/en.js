export default {
    ...
    liangdians: {
      ...
      l3: "Upgrade and match of diesel oil quality for China VI standard",
      l4: "Current market and trend of major diesel vehicle consuming countries",
      l5: "Diesel market focus and legislative progress on NAFTA, EU, Brazil, Russia, India, SEA, etc.",
      l6: "Research on the Overall Technology of Clean diesel engine meeting China VI standard",
      l7: "High Efficient SCR system",
      l8: "Optimal solution of AdBlue technology and its supply & distribution",
      l9: "Research on reliability and durability of EGR engines",
      l10: "DPF passive regeneration technology",
      l11: "Choose or give up—comparison and integration of different aftertreatment technology routes",
      l12: "Efficient and advanced in-cylinder combustion technology",
      l13: "Technical challenges of high pressure common rail fuel system by electronic control",
      l14: "Efficient turbocharging technology of diesel engine for medium and heavy commercial vehicles",
      l15: "The technical requirements and development trend of engine thermal management with continuous enhancement of national standard",
      l16: "Future technical upgrade of diesel engines in heavy trucks",
      l17: "Energy-conservation technical effects and trends of Powertrain from commercial vehicles",
      l18: "Future development trend of non-road Euro V diesel engine technology and construction machinery",
      l19: "Design and control strategy of non-road diesel-electric hybrid power system",
      l20: "Technical development trend of agricultural mahinery and R & D of diesel engines meeting China IV standard",
      l21: "Where could we go from here? -- The Future of diesel engines"
    },
    zhengfuxiehui: {
      z1: "生态环境部",
      z2: "济南汽车检测中心",
  ...
  meeting: {
    subtitle: "",
    address: "April 10-11, 2019, Shanghai, China",
    ...
    attend1: "With high thermal efficiency and strong power performance, diesel engine can reduce 45% emissions of greenhouse gases. However, NOx and PM generated from combustion by diesel engine are the largest source of PM2.5. Diesel-powered trucks which account for only 7.8% of car parc, emit 57.3% NOx and 77.8% PM, being the top priority of prevention and treatment of pollution of motor vehicles. Hence, national ministries and commissions put pollution treatment of heavy-duty trucks high on the agenda of the tough battle of pollution prevention and treatment in 2018. ",
    attend2: "The emission limit plan of China 6a will be implemented in 2020 and of China 6b in 2023 in accordance with the latest policies. In such tough situation, whether commercial vehicles, non-road mobile machinery, engines manufacturers, or professional providers of emission technologies need to strengthen R&D update of energy conservation and emission reduction technologies, even make a layout of alternative energies and new energies products in advance as to prepare to meet tighter emission regulations. ",
